      ...
      <Grid container spacing={4}>
        <Grid container item sm={6} className={classes.mobile}>
          <Grid item xs={12} style={{ textAlign: 'center' }}>
            <img src="/atenews-footer.svg" height="40"></img>
          </Grid>
        </Grid>
        <Grid container item sm={3} direction="column" justify="space-between">
          ...
          <Grid item container spacing={2}>
            ...
            <Grid container item spacing={2}>
              ...
              <Grid item xs={11}>
                <Typography variant="body1"><b>Atenews Office</b>, Ground Floor, Arrupe Hall, Martin Building, Ateneo de Davao University, E. Jacinto St., 8016 Davao City, Philippines</Typography>
              </Grid>
            </Grid>
          </Grid>
        ...
        <Grid container item sm={3} direction="column" justify="space-between">
          ...
          <Grid item>
            <Typography variant="body1">© {(new Date()).getFullYear()} <b>Atenews</b></Typography>
          </Grid>
        </Grid>
      </Grid>
    </div>
